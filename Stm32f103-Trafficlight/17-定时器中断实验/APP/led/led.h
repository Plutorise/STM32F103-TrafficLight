...
/* 交通灯GPIO定义 */
#define GREEN_LIGHT_PORT    GPIOB
#define GREEN_LIGHT_PIN     GPIO_Pin_0
#define GREEN_LIGHT_RCC     RCC_APB2Periph_GPIOB

#define YELLOW_LIGHT_PORT   GPIOB
#define YELLOW_LIGHT_PIN    GPIO_Pin_1
#define YELLOW_LIGHT_RCC    RCC_APB2Periph_GPIOB

#define RED_LIGHT_PORT      GPIOB
#define RED_LIGHT_PIN       GPIO_Pin_2
#define RED_LIGHT_RCC       RCC_APB2Periph_GPIOB
...
/* 交通灯位带定义 */
#define GREEN_LIGHT    PBout(0)
#define YELLOW_LIGHT   PBout(1)
#define RED_LIGHT      PBout(2)
